...
@Config
@Autonomous(name = "QuadSpecimen-AutoRR", group = "Autonomous")


public class UltimateQuadrupleSpecimenDeluxePlusPlusUltra extends LinearOpMode {
    // armBase class
    public class Lift {
    ...
    public void runOpMode() {
        Pose2d initialPose = new Pose2d(-9, 62, Math.toRadians(90));
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                ...
                .splineToConstantHeading(new Vector2d(-36, 15), Math.toRadians(180))
                .setTangent(Math.toRadians(90))
                ...
                .splineToConstantHeading(new Vector2d(-50.1, 45), Math.toRadians(90))
                ...
                .afterTime(0, drive.SetLiftTarget(0))
                .setTangent(Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(-38, 45, Math.toRadians(90)), Math.toRadians(270))
                .waitSeconds(1.25)
                .afterTime(0.25, claw.closeClaw())
                .waitSeconds(0.5)
                .afterTime(0, drive.SetLiftTarget(-1968))
                ...
                .setTangent(Math.toRadians(270))
                .splineToLinearHeading(new Pose2d(-1, 30, Math.toRadians(90)), Math.toRadians(270))
                .afterTime(0.25, drive.SetLiftTarget(-1328))
                .afterTime(0.5, claw.openClaw())
                .waitSeconds(0.75)
                .afterTime(0, drive.SetLiftTarget(0));
